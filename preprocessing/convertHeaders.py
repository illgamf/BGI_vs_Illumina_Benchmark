...
# Please note that you will need to provide the sample barcode sequence
# with the input FASTQ file
# format example:
# BGI: @20A_V100002918L1C001R006000020/1
# Illumina: @A00488:12:H7HTJDSXX:1:1101:2826:1000 1:N:0:ACCCTCCT
def parseBGI(header):
...
def parseArguments(args):
    ...
    return input_file, output_file, barcode
...
if __name__ == "__main__":
    args = setupParser()
    input_file, output_file, sample_barcode = parseArguments(args)
